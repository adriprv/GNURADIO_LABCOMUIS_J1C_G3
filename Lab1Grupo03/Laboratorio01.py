...
class Laboratorio01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Laboratorio01")
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(10000, 400000, 1000, 20000, 200)
...
def main(top_block_cls=Laboratorio01, options=None):
