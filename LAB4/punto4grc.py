...
class punto4grc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "punto4grc")
        ...
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "Amplited Portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100e3, A, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.CalculoPotenciaComuG03_0, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.Envolvente_compleja_0.set_K(self.Ka)
...
def main(top_block_cls=punto4grc, options=None):
