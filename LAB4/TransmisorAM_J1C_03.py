...
from Modulador_AM_J1C03 import Modulador_AM_J1C03  # grc-generated hier_block
...
class TransmisorAM_J1C_03(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TransmisorAM_J1C_03")
        ...
        self.Modulador_AM_J1C03_0 = Modulador_AM_J1C03(
            Ac=Ac,
            Ka=Ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulador_AM_J1C03_0, 0), (self.uhd_usrp_sink_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulador_AM_J1C03_0, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.Modulador_AM_J1C03_0.set_Ka(self.Ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Modulador_AM_J1C03_0.set_Ac(self.Ac)
...
def main(top_block_cls=TransmisorAM_J1C_03, options=None):
