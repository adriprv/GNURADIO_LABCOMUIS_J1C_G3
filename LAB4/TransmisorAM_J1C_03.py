...
class TransmisorAM_J1C_03(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1e6, A, 0, 0)
        ...
        self.connect((self.Envolvente_compleja_0, 0), (self.uhd_usrp_sink_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.CalculoPotenciaJ1C_0, 0))
